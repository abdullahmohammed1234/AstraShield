...
const breakupRoutes = require('./routes/breakupRoutes');
const kesslerRoutes = require('./routes/kesslerRoutes');
const missionPlanningRoutes = require('./routes/missionPlanningRoutes');
const lifetimeRoutes = require('./routes/lifetimeRoutes');
const closestApproachRoutes = require('./routes/closestApproachRoutes');
const riskThresholdRoutes = require('./routes/riskThresholdRoutes');
...
app.use('/api/breakup', breakupRoutes);
app.use('/api/kessler', kesslerRoutes);
app.use('/api/mission-planning', missionPlanningRoutes);
app.use('/api/lifetime', lifetimeRoutes);
app.use('/api/closest-approach', closestApproachRoutes);
